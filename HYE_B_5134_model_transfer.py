...
# ====================== Load data ======================
## Experiment data
swaps_config_path = "/cmnfs/proj/ORIGINS/SWAPS_exp/mixture/B_5134_20240910_142359_518485/config_20240910_142359_518485.yaml"
peak_selection_config_path = "/cmnfs/proj/ORIGINS/SWAPS_exp/mixture/B_5136_20240910_142359_508367/peak_selection/exp_20240910_183334_484312/updated_peak_selection_config.yaml"
ps_exp_dir = os.path.join("peak_selection", "eval_B_5134")
eval_test = True
...
if eval_test:
    ...
    if len(cfg.PEAK_SELECTION.TRAINING_DATA) == 0:
        ...
        training_file_paths = cfg.PEAK_SELECTION.TRAINING_DATA
